...
const Career = () => {
  ...
  const careerEvents = [
    ...
    },
    {
      ...
      description: "Learn to create a standout resume that gets noticed",
    ...
    },
    {
      ...
      description: "Network with professionals from the tech industry",
    ...
    },
    {
      ...
      description: "Learn effective strategies for salary negotiations",
  ...
  const handleInterested = () => {
    ...
    if (!isInterested) {
      alert('You are now interested in Career events!');
    } else {
      alert('You are no longer interested in Career events.');
    }
  };
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 gap-4">
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              <span className="px-3 py-1 text-xs font-medium bg-[#c2b490]/10 text-[#c2b490] rounded-full">Career</span>
              <span className="px-3 py-1 text-xs font-medium bg-gray-100 text-gray-600 rounded-full">Jobs</span>
