...
const Business = () => {
  ...
  const businessEvents = [
    ...
    },
    {
      ...
      description: "Explore investment opportunities and financial strategies",
  ...
  const handleInterested = () => {
    ...
    if (!isInterested) {
      alert('You are now interested in Business events!');
    } else {
      alert('You are no longer interested in Business events.');
    }
  };
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 gap-4">
          <div>
            <h1 className="text-4xl font-bold text-gray-900 mb-2">Business</h1>
            <div className="flex flex-wrap gap-2">
              <span className="px-3 py-1 text-xs font-medium bg-[#c2b490]/10 text-[#c2b490] rounded-full">Business</span>
