...
const Music = () => {
  ...
  const musicEvents = [
    ...
    },
    {
      ...
      description: "Celebrate jazz music with renowned artists from around the world",
    ...
    },
    {
      ...
      description: "Dance to the beats of top DJs and electronic music producers",
    ...
    },
    {
      ...
      description: "An elegant evening of classical music performances",
    ...
    },
    {
      ...
      description: "Live hip hop performances by emerging and established artists",
  ...
  const handleInterested = () => {
    ...
    if (!isInterested) {
      alert('You are now interested in Music events!');
    } else {
      alert('You are no longer interested in Music events.');
    }
  };
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 gap-4">
          <div>
            <h1 className="text-4xl font-bold text-gray-900 mb-2">Music</h1>
            <div className="flex flex-wrap gap-2">
              <span className="px-3 py-1 text-xs font-medium bg-[#c2b490]/10 text-[#c2b490] rounded-full">Music</span>
              <span className="px-3 py-1 text-xs font-medium bg-gray-100 text-gray-600 rounded-full">Concerts</span>
              <span className="px-3 py-1 text-xs font-medium bg-gray-100 text-gray-600 rounded-full">Festivals</span>
            </div>
          </div>
          <button
